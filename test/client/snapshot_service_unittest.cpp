...
TEST(SnapInstance, ReadChunkSnapshotTest) {
    ...
    ioctxmana->ReadSnapChunk(ChunkIDInfo(cid, 2, 3), 1, EmptyCloneFileInfos(1), 0,
                                         len, buf, &scc);
    ...
    ASSERT_EQ(0,
    ioctxmana->ReadSnapChunk(ChunkIDInfo(cid, 2, 3), 1, EmptyCloneFileInfos(1), 0, len, buf, &scc2));
